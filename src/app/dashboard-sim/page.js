        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="rounded-xl bg-bg-card border border-border p-4">
            ...
            <div className="mt-2 h-2 bg-bg-elevated rounded-full overflow-hidden">
              <div
                className={`h-full transition-all ${riskScore === "Low"
                  ? "w-1/3 bg-success"
                  : riskScore === "Medium"
                    ? "w-2/3 bg-warning"
                    : riskScore === "High"
                      ...
                      >
                        <div className="flex-1">
                          <div className="flex items-center gap-2">
                            ...
                            <span className={`px-2 py-0.5 rounded text-xs ${holding.risk === "Low" ? "bg-success/10 text-success" :
          ...
          <div className="space-y-6">
                ...
                <div className="space-y-3 max-h-80 overflow-y-auto">
                  {activeTransactions.slice(0, 10).map((tx) => (
                    <div key={tx.id} className="flex items-center gap-3 p-3 rounded-lg bg-bg-elevated">
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center ${tx.type === "BUY" ? "bg-success/10 text-success" :
                      ...
                      <div className="text-right">
                        <p className={`text-sm font-medium ${tx.type === "BUY" ? "text-danger" :
            ...
            <div className="rounded-xl bg-bg-card border border-border p-5">
              ...
              <div className="space-y-4">
                ...
                {/* Parent Funding Info */}
                <div className={`p-3 rounded-lg mt-4 ${accountMode === "real"
                  ? "bg-warning/10 border border-warning/20"
                  : "bg-primary/10 border border-primary/20"
                  }`}>
                  <p className={`text-sm font-medium mb-1 ${accountMode === "real" ? "text-warning" : "text-primary"
                    }`}>
